                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <form id="adddorm" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="dorm_name">Dorm Name</label>
                                                <input type="text" name="dorm_name" id="dorm_name" class="form-control" placeholder="Enter First Name">
                                            </div>
            ...
            <!-- end app-container -->
            <script src="<?=base_url();?>assets_admin/js/custom/admin/adddorm.js"></script>
